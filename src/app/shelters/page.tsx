                ...
                <div className="flex items-center justify-between px-4 pt-2 pb-1">
                    ...
                    <div className="flex items-center bg-gray-100 rounded-lg overflow-hidden">
                        <button
                            ...
                            className={`px-3 py-1.5 flex items-center gap-1 min-h-[36px] transition-colors text-sm ${viewMode === 'list'
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 flex items-center gap-1 min-h-[36px] transition-colors text-sm ${viewMode === 'map'
                                    ? 'bg-[#0F52BA] text-white'
                                    : 'text-gray-600'
                                }`}
                        >
                            ...
                            {filteredShelters.slice(0, 3).map((shelter) => (
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between mt-1.5">
                                        <span
                                            className={`text-xs px-2 py-0.5 rounded-full ${shelter.isOpen
