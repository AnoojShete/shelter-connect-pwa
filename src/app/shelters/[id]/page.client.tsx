...
export default function ShelterDetailClient({ shelter }: ShelterDetailClientProps) {
    ...
    return (
        <div className="flex flex-col min-h-[calc(100vh-57px)] bg-white">
            ...
            <div className="flex-1 overflow-y-auto pb-36">
                ...
                <div
                    className={`px-4 py-3 flex items-center justify-between ${shelter.isOpen ? 'bg-green-50' : 'bg-gray-100'
                        }`}
                >
                    <div>
