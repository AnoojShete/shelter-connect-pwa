            ...
            <div className="flex-1 mt-4 relative">
                ...
                <div className="absolute top-3 right-3 z-10 bg-white rounded-lg shadow-md flex overflow-hidden border border-gray-200">
                    <button
                        ...
                        className={`px-3 py-2 flex items-center gap-1.5 min-h-[40px] transition-colors ${viewMode === 'list'
                    ...
                    <button
                        ...
                        className={`px-3 py-2 flex items-center gap-1.5 min-h-[40px] transition-colors ${viewMode === 'map'
                                ? 'bg-[#0F52BA] text-white'
                                : 'text-gray-600 hover:bg-gray-50'
                            }`}
                    >
