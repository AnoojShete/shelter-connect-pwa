                        ...
                        <div className="border-t border-gray-200">
                            {emergencyContacts.map((contact, index) => (
                                <a
                                    ...
                                    className={`flex items-center gap-3 px-4 py-3 min-h-[60px] hover:bg-[#E0F7FA]/50 transition-colors ${index < emergencyContacts.length - 1
                    ...
                    {expandedSection === 'safety' && (
                        <div className="border-t border-gray-200">
                            {safetyTips.map((tip, index) => (
                                <div
                                    key={tip.id}
                                    className={`px-4 py-3 ${index < safetyTips.length - 1
                                            ? 'border-b border-gray-100'
                                            : ''
                                        }`}
                                >
