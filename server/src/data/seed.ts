/**
 * Seed data for the Express API server.
 * This data mirrors the original Next.js mock data and will be replaced
 * by MongoDB queries in Practical 8.
 */
...
export const shelters: Shelter[] = [
    {
        ...
        bedsAvailable: 12,
        totalBeds: 30,
        amenities: { beds: true, wifi: true, food: true, medical: false, nightStay: true },
        filters: ['All', 'Family', 'Open Now'],
        phone: '(555) 123-4567',
        address: '123 Main Street, Downtown',
        description: 'A safe, welcoming environment providing emergency shelter, meals, and supportive services for families and individuals experiencing homelessness.',
    ...
    },
    {
        ...
        bedsAvailable: 5,
        totalBeds: 20,
        amenities: { beds: true, wifi: true, food: true, medical: true, nightStay: true },
        filters: ['All', 'Women-Only', 'Open Now'],
        phone: '(555) 234-5678',
        address: '456 Oak Avenue, Midtown',
        description: 'Dedicated to providing safe shelter and comprehensive support services exclusively for women in need.',
    ...
    },
    {
        ...
        bedsAvailable: 8,
        totalBeds: 15,
        amenities: { beds: true, wifi: false, food: true, medical: false, nightStay: true },
        filters: ['All', 'Pet-Friendly', 'Family', 'Open Now'],
        phone: '(555) 345-6789',
        address: '789 Elm Street, Westside',
        description: 'One of the few shelters that welcomes both individuals and their beloved pets.',
    ...
    },
    {
        ...
        description: 'Large capacity shelter providing emergency housing and wraparound services.',
    ...
    },
    {
        ...
        description: 'Specialized in serving families with children, offering private family rooms and childcare support.',
